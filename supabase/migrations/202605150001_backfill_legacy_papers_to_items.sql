-- Backfill legacy public.papers rows into the normalized items schema.
-- Safe to rerun: existing item rows are updated by legacy_paper_id and
-- attachments/tags are inserted only when missing.
